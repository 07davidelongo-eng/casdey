    ...
    <form action={action} className="space-y-6">
      <Card>
        ...
        <p className="mb-5 text-[0.875rem] text-stone">
          ...
          practice, the same way its emails go out from{" "}
          <span className="literal">mail.casdey.com</span>. Every message is
          signed with your practice name, and only patients you have imported
          and who have not opted out are ever contacted.
        </p>
      ...
      <Card>
        ...
        <p className="mb-5 text-[0.875rem] text-stone">
          WhatsApp requires Meta to pre-approve the exact wording of any
          message that opens a conversation. That approval happens outside
          casdey, in Twilio&apos;s Content Template Builder. Once approved, paste
          its Content SID here.
        </p>
        ...
        <div className="max-w-[24rem]">
          ...
          <input
            id={`${id}-template`}
            name="templateName"
            defaultValue={practice.whatsapp_template_name ?? ""}
